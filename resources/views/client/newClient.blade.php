            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-sm-6 text-left">
                        <h3 class="title">{{ __('Nuevo Cliente') }}</h3>
                    </div>
                </div>
                <form method="post" action="{{route('client.save')}}" autocomplete="off">
                    <div class="card-body">
                        @csrf
                    ...
                    <div class="card-footer">
                        <a href="{{route('viewClients')}}"><button class="btn btn-fill btn-primary" title="Volver a Clientes"><i class="tim-icons icon-double-left"></i></button></a>
                    </div>
            </div>
        </div>
    </div>
