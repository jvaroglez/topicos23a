    ...
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <p class="text-dark mb-2">Inicia sesión con tu <strong>email</strong> y tu <strong>password</strong></p>
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-right">
                        <h6>
                            <a href="{{ route('password.request') }}" class="link footer-link">{{ __('Olvidaste tu password?') }}</a>
                        </h6>
                    </div>
                </div>
            </div>
